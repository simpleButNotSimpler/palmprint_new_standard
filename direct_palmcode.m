function score = direct_palmcode(dc_test_im, canny_test_im, database_dc, database_canny, db_len)
...
for k=1:db_len    
    score_dc_orig = palmcode_diff_weights_fused(dc_test_im, database_dc(k).im, canny_test_im, database_canny(k).im);
